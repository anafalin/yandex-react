...
export function Calculator() {
  ...
  const onNumberClick = React.useCallback(
    ...
    [value, decimalPending, finishDecimal],
  );
  ...
  return (
    <div className={container}>
      <div className={pad}>
        ...
        <button
          onClick={onOperationClick("divide")}
          className={btn}
          disabled={decimalPending}
        >
          ÷
        </button>
        ...
        <button
          onClick={onOperationClick("multiply")}
          className={btn}
          disabled={decimalPending}
        >
          ×
        ...
        <button
          onClick={onOperationClick("minus")}
          className={btn}
          disabled={decimalPending}
        >
          -
        ...
        <button
          ...
          className={`${btn} ${btn_equal}`}
          disabled={decimalPending}
        >
          =
        </button>
        <button
          onClick={onOperationClick("plus")}
          className={btn}
          disabled={decimalPending}
        >
          +
