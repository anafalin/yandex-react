  ...
  render() {
    return (
      <div className="main__container">
        ...
        <p className="main__text">{`Цвет: ${this.props.data.color}`}</p>
        <p className="main__text">{`Материал: ${this.props.data.material}`}</p>
        <p className="main__text">{`Вес: ${this.props.data.weight} кг`}</p>
      </div>
    );
  }
}
  ...
  render() {
    ...
    return (
      <article className="main">
        ...
        <ProductSpecs data={data.properties} />
        <div className="main__container">
