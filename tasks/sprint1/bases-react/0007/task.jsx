    ...
    return (
      <div className="content">
        ...
        <div id="news-container" className="beautiful-container d-flex-column">
          ...
          <section className="post good-news">Туристы обнаружили выживавшую в снегах две недели собаку и вернули её домой</section>
          <section className="post good-news">На Аляске выбрали самого жирного медведя</section>
          <section className="post good-news">Хитрый чихуахуа приучился кататься верхом и плавать на своем друге лабрадоре</section>
